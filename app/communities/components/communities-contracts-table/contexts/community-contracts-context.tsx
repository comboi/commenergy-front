...
interface CommunityContractsContextType {
  ...
  updateSharing: (contractId: string, newSharingValue: number, sharingActiveVersion: any) => void;
  resetDraftData: () => void;
...
const CommunityContractsContext = createContext<CommunityContractsContextType | undefined>(undefined);
...
export const CommunityContractsProvider: React.FC<CommunityContractsProviderProps> = ({
  children,
  data,
}) => {
  ...
  const updateSharing = useCallback(
    (contractId: string, newSharingValue: number, sharingActiveVersion: any) => {
...
export const useCommunityContracts = (): CommunityContractsContextType => {
  ...
  if (context === undefined) {
    throw new Error('useCommunityContracts must be used within a CommunityContractsProvider');
  }
  return context;
};
