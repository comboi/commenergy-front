...
import {
  ...
  useUserCommunities,
} from '@/app/platform/communities/services/communities/useCommunityUsers';
import { CommunityUser } from '@/app/platform/communities/model/communityUser';
                ...
                <div className="space-y-1 p-3 border rounded-md">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <div className="text-sm font-medium">
                      {String(newUser?.name || newUser.vat)}
                    </div>
