...
import { useCommunityContracts } from '@/app/platform/communities/services/communityContracts/useCommunityContracts';
...
import { BulkImportModal } from './modals/bulk-import-modal';
...
const CommunityContractsTableContent = ({
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      ...
      {/* Show empty state when there are no contracts */}
      {!isLoading && filteredData.length === 0 ? (
        <EmptyState
          isLoggedUserAdmin={isLoggedUserAdmin}
          onAddContract={() => setIsAddNewOpen(true)}
