...
import { useUpdateCommunityContract } from '@/app/platform/communities/services/communityContracts/useUpdateCommunityContract';
import { useCreateCommunityContract } from '@/app/platform/communities/services/communityContracts/useCreateCommunityContract';
import { useContracts } from '@/app/platform/contracts/services/useContracts';
import AddNewContractForm from '@/app/platform/contracts/components/add-new-contract/add-new-contract-form';
