...
} from '@/app/platform/communities/services/communityContracts/useCommunityContractDocuments';
import { useDeleteDocument } from '@/app/platform/communities/services/documents/useDeleteDocuments';
import { useCreateTermsAgreement } from '@/app/platform/communities/services/termsAgreements/useCreateTermsAgreement';
import { useTermsAgreementsByCommunityContract } from '@/app/platform/communities/services/termsAgreements/useTermsAgreements';
...
const CommunityContractDocumentsForm = ({
  ...
  return (
    <div className="relative">
      ...
      {hasExistingTermsAgreement && existingTermsAgreement && (
        <div className="absolute bottom-4 left-0 flex items-center gap-2">
          ...
          <span className="text-sm text-gray-600">
            Accepted on {formatDate(existingTermsAgreement.acceptanceDate)}
          </span>
        </div>
      )}
        ...
        <div className="flex justify-end gap-4">
          ...
          {!hasExistingTermsAgreement && (
            <ButtonWithTooltip
              ...
              disabled={hasMissingDocuments || isCreatingTermsAgreement}
              tooltip={hasMissingDocuments ? 'Missing documents' : ''}>
